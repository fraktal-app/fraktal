...
export default function Login() {
  ...
  return (
    ...
    <ToastContainer
      ...
      transition={Bounce}
      />
  <div className="w-1/2 relative h-full bg-black flex flex-col justify-center items-center p-12 overflow-hidden rounded-r-[4rem]">

    <div className="absolute inset-0 z-0">
      <Aurora
        colorStops={["#1e1e73", "#6930c3", "#FF1E7C"]}
        amplitude={1.0}
        blend={0.5}
        speed={0.1}
        time={0}
    ...
    <div className="text-white z-10">
      <h1 className="font-syne text-6xl font-bold leading-tight text-left">
        Automated Workflows
        <br />
        on the 
        <br />
        <span className="relative text-cyan-400">
          Internet Computer
          <span className="absolute bottom-[-8px] left-0 w-full h-1 bg-cyan-400" />
        </span>
      </h1>
    </div>
  </div>
      <div className="w-1/2 bg-black flex items-center justify-center p-12">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            <h2 className="font-syne text-white text-4xl font-semibold mb-3">Login</h2>
            <p className="text-gray-400 text-base">
              Choose a provider to get started
            </p>
          </div>
          <div className="space-y-4">
            <button className="w-full bg-[#2C2C2C] hover:bg-gray-700 text-white py-3 px-6 rounded-lg flex items-center justify-center gap-3 transition-colors duration-200" onClick={() => handleSignUp('google')}>
            ...
            <button className="w-full bg-[#2C2C2C] hover:bg-gray-700 text-white py-3 px-6 rounded-lg flex items-center justify-center gap-3 transition-colors duration-200" onClick={() => handleSignUp('github')}>
